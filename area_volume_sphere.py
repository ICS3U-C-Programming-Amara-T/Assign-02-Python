...
def main():
    #Greeting
    print("Hello! Lets find the surface area and volume of a sphere!")
    ...
    print("3. green")
    print("4. red")
    color_choice = input("Enter the # (1-4)")
    ...
    print("")
    print(f"Volume: {color} {volume:.2f} {units}^3".format(volume, units))
    print(f"Surface Area: {color}{surface_area:.2f} {units}^2".format(surface_area, units))
